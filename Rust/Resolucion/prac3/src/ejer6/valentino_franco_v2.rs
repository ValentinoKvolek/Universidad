...
impl Estudiante{
    ...
    //me di cuenta que la forma que habia pensado originalmente en la v1 recorria muchas veces mi vector de calificaciones.
    //entonces cree un metodo aparte que recorre una vez para encontrar max y min, con sus nombres.
