...
public class tp1_ejer1 {
    ...
    public static void imprimir(int a, int b){   //recursivo
        if(a<=b){
            System.out.println(a);
            imprimir(a+1, b);
        }
    ...
    public static void main(String[] args) {
        ...
        imprimirWhile(a,b);
        System.out.println("sin nada (recursivo) : ");
        imprimir(a,b);
